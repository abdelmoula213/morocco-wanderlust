...
const things = [
  ...
  {
    num: 3, title: "Agafay Desert Experience", image: agafayImage, link: "/agafay-desert",
  ...
  {
    num: 4, title: "Day Trip to Atlas Mountains (Imlil)", image: atlasImage, link: "/atlas-mountains",
    shortDesc: "Escape to cool mountain air.",
    longDesc: "Just 60 km from Marrakech, the Imlil Valley in the High Atlas Mountains feels like another world. Walk through traditional Berber villages where life has barely changed in centuries, follow trails past walnut groves and terraced fields to hidden waterfalls, and enjoy a traditional tagine lunch with panoramic mountain views. On clear days, you can see the peak of Mount Toubkal (4,167m) — North Africa's highest mountain. The drive itself is stunning, winding through deep valleys and past colorful markets.",
  ...
  {
    num: 5, title: "Visit Jardin Majorelle & YSL Museum", image: null, link: null,
  ...
  {
    num: 8, title: "Essaouira Coastal Day Trip", image: essaouiraImage, link: "/essaouira",
    shortDesc: "Atlantic breezes and fresh seafood.",
    longDesc: "Essaouira is Morocco's most charming coastal town — a UNESCO-listed medina of blue-shuttered buildings, art galleries, and a bustling fishing port. The 2.5-hour drive from Marrakech passes through argan tree forests (watch goats climbing the trees!). In Essaouira, wander the car-free medina, visit artisan workshops, eat the freshest seafood you've ever had at the port grill stalls, and walk along the windswept beach. The town has a completely different vibe to Marrakech — relaxed, artistic, and bohemian. It's also famous for its windsurfing and kitesurfing.",
      ...
      <article className="container mx-auto px-4 py-16 max-w-3xl">
        ...
        <div className="bg-secondary rounded-xl p-6 mb-10">
          ...
          <ul className="space-y-2">
            {things.map((t) => (
              <li key={t.num} className="font-body text-sm text-primary hover:underline cursor-pointer">
                {t.num}. {t.title} — <span className="text-muted-foreground">{t.shortDesc}</span>
              </li>
            ))}
          </ul>
        </div>
        ...
        <p className="font-body text-lg text-muted-foreground leading-relaxed mb-4">
          Marrakech is Morocco's most exciting city — a whirlwind of colors, flavors, and unforgettable experiences. Known as the "Red City" for its distinctive terracotta walls, Marrakech has been a crossroads of African, Arab, and European cultures for over a thousand years.
        </p>
        <p className="font-body text-muted-foreground leading-relaxed mb-12">
          Whether you have 2 days or 2 weeks, these are the 10 experiences you absolutely cannot miss. We've included practical tips, prices, and booking advice for each one — from a team of local guides who've been showing visitors around Morocco for over 10 years.
        </p>
              ...
              <div className="flex items-start gap-4 mb-4">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-3 mt-1">
                    <span className="font-body text-xs text-muted-foreground flex items-center gap-1"><Clock size={12} /> {thing.duration}</span>
                  </div>
                </div>
              </div>
              <div className="ml-[64px]">
                {thing.image && (
                  <img src={thing.image} alt={thing.title} className="rounded-xl w-full h-56 object-cover mb-4" loading="lazy" />
                )}
                <p className="font-body text-muted-foreground leading-relaxed mb-4">{thing.longDesc}</p>
        ...
        <div className="mt-16 mb-10">
          <h2 className="font-heading text-2xl md:text-3xl font-bold text-foreground mb-4">Bonus: Marrakech Travel Tips</h2>
        ...
        <div className="bg-card rounded-2xl p-8 shadow-warm-lg text-center">
          ...
          <p className="font-body text-muted-foreground mb-6">
            Book any tour with SEE&KNOW — best direct prices, free cancellation, and pay on arrival. We'll handle the logistics, you just enjoy Morocco.
          </p>
        ...
        <div className="mt-12 pt-10 border-t border-border">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <Link to="/guides/best-sahara-desert-tour-marrakech" className="bg-card rounded-xl p-4 shadow-warm hover:shadow-warm-lg transition-all group">
              ...
              <p className="font-body text-xs text-muted-foreground mt-1">Complete guide to choosing the right Sahara tour</p>
            </Link>
            <Link to="/guides/is-morocco-safe-for-tourists" className="bg-card rounded-xl p-4 shadow-warm hover:shadow-warm-lg transition-all group">
              ...
              <p className="font-body text-xs text-muted-foreground mt-1">Honest safety guide from local experts</p>
            </Link>
          </div>
        </div>
      </article>
