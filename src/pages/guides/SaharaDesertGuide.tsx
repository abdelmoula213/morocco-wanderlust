...
import { CheckCircle, Clock, MapPin, Phone, Star, Users, X, AlertTriangle } from "lucide-react";
    ...
    <>
      ...
      <article className="container mx-auto px-4 py-16 max-w-3xl">
        ...
        <div className="bg-secondary rounded-xl p-6 mb-10">
          <h2 className="font-heading text-lg font-bold text-foreground mb-3">What's in This Guide</h2>
          <ul className="space-y-2">
            {["Overview: What Is the 3-Day Sahara Tour?", "Day 1: Marrakech to Dades Valley", "Day 2: Todra Gorge to Sahara Desert Camp", "Day 3: Sunrise & Return to Marrakech", "What's Included in the Price", "Accommodation: Hotels & Desert Camps", "The Camel Trek Experience", "Desert Camp Life: What to Expect", "Best Time to Go", "What to Pack (Complete List)", "Tips for Photographers", "Frequently Asked Questions"].map((item, i) => (
        ...
        <p className="font-body text-lg text-muted-foreground leading-relaxed mb-4">
          Planning a 3-day Sahara desert tour from Marrakech? You're about to embark on Morocco's most unforgettable journey — a 1,000+ kilometer road trip through ancient mountain passes, dramatic gorges, palm oases, and finally, the golden dunes of the Sahara.
        </p>
        <p className="font-body text-muted-foreground leading-relaxed mb-10">
          This guide covers every detail: what happens each day, hour by hour, what's included in the price, what the accommodation is really like, what to pack, and honest tips from guides who run this tour every single week.
        </p>

        {/* Overview */}
        <h2 className="font-heading text-2xl md:text-3xl font-bold text-foreground mb-4">Overview: What Is the 3-Day Sahara Tour?</h2>
        <p className="font-body text-muted-foreground leading-relaxed mb-4">
          The 3-day Sahara tour is Morocco's most popular multi-day excursion. Starting from Marrakech, you'll travel southeast across the High Atlas Mountains, through the dramatic landscapes of southern Morocco, all the way to the Erg Chebbi sand dunes near Merzouga — the gateway to the Sahara Desert.
        </p>
        ...
        {[
          {
            ...
            sections: [
              { subtitle: "Morning: Crossing the Atlas Mountains", text: "Your driver picks you up from your riad or hotel in Marrakech around 7:00-8:00 AM. The journey begins with one of Morocco's most scenic drives — the winding road up to the Tizi n'Tichka pass at 2,260 meters. Along the way, you'll see Berber villages perched on mountainsides, terraced fields, and (in winter) snow-capped peaks. There are several stops for photos and refreshments along the way." },
          ...
          <div key={i} className="mb-12">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <h3 className="font-heading text-xl font-bold text-foreground">{day.title}</h3>
            ...
            <div className="ml-[60px] space-y-4">
              {day.sections.map((s, j) => (
                <div key={j}>
                  <h4 className="font-heading text-base font-bold text-foreground mb-2">{s.subtitle}</h4>
              ...
              <div className="bg-secondary rounded-lg p-4 mt-4">
                <p className="font-body text-xs font-semibold text-secondary-foreground uppercase tracking-wider mb-2">Key Highlights</p>
        ...
        <div className="grid grid-cols-2 gap-4 mb-12">
          <img src={saharaImage} alt="Sahara Desert golden dunes at sunset" className="rounded-xl w-full h-48 object-cover" loading="lazy" />
          <img src={aitBenHaddouImage} alt="Ait Ben Haddou Kasbah Morocco" className="rounded-xl w-full h-48 object-cover" loading="lazy" />
        </div>

        {/* What's Included */}
        <h2 className="font-heading text-2xl md:text-3xl font-bold text-foreground mb-4">What's Included in the Price</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-10">
          <div>
            <h3 className="font-body text-sm font-semibold text-primary uppercase tracking-wider mb-3">✅ Included</h3>
            <ul className="space-y-2">
              {["Hotel/riad pickup & drop-off", "Air-conditioned minivan transport", "2 nights accommodation", "Camel trek (sunset + sunrise)", "Dinner & breakfast at camp", "English-speaking driver/guide", "Guided visit to Ait Ben Haddou", "All road tolls and fuel"].map((item) => (
          ...
          <div>
            ...
            <ul className="space-y-2">
              {["Lunches (~40-60 DH each)", "Drinks and snacks", "Tips (optional, appreciated)", "Personal expenses", "Travel insurance"].map((item) => (
        ...
        {/* Accommodation */}
        <h2 className="font-heading text-2xl md:text-3xl font-bold text-foreground mb-4">Accommodation: Hotels & Desert Camps</h2>
        <p className="font-body text-muted-foreground leading-relaxed mb-4">
          Your first night is in a hotel/riad in the Dades Valley area. The second night is the highlight — sleeping in a desert camp in the Sahara.
        </p>
        <div className="space-y-4 mb-10">
          <div className="bg-card rounded-xl p-5 shadow-warm">
            <h3 className="font-heading text-base font-bold text-foreground mb-2">Standard Camp</h3>
            <p className="font-body text-sm text-muted-foreground">Berber-style tents with traditional mattresses, blankets, and shared bathroom facilities. Simple but authentic. You'll have a communal dining area and campfire space. Most camps accommodate 15-25 guests.</p>
          </div>
          <div className="bg-card rounded-xl p-5 shadow-warm border-2 border-accent">
            <h3 className="font-heading text-base font-bold text-foreground mb-2">Luxury Camp ⭐</h3>
            <p className="font-body text-sm text-muted-foreground">Private tents with real beds, quality linens, rugs, and en-suite private bathrooms with hot water. Some luxury camps include electricity, charging points, and even heated tents in winter. A much more comfortable experience, especially for couples.</p>
          </div>
        </div>

        {/* Camel Trek */}
        <h2 className="font-heading text-2xl md:text-3xl font-bold text-foreground mb-4">The Camel Trek Experience</h2>
        <p className="font-body text-muted-foreground leading-relaxed mb-4">
          The camel ride is the most iconic part of the trip. Here's what to expect:
        </p>
        ...
        <div className="bg-secondary rounded-xl p-4 mb-10">
          <p className="font-body text-sm text-secondary-foreground">
            ...
            <strong>Tip:</strong> Wear long pants for the camel ride — shorts can cause chafing against the saddle.
          </p>
        </div>

        {/* Desert Camp Life */}
        <h2 className="font-heading text-2xl md:text-3xl font-bold text-foreground mb-4">Desert Camp Life: What to Expect</h2>
        <p className="font-body text-muted-foreground leading-relaxed mb-4">
          Arriving at camp after the camel trek is magical. Here's a typical evening:
        </p>
        <div className="space-y-3 mb-10">
          {[
            { time: "5:30 PM", event: "Arrive at camp, welcome mint tea" },
            { time: "6:00 PM", event: "Climb a nearby dune for sunset photos" },
            { time: "7:30 PM", event: "Traditional Berber dinner (tagine, couscous, salads)" },
            { time: "9:00 PM", event: "Campfire with Berber drumming and singing" },
            { time: "10:00 PM", event: "Stargazing on the dunes (bring a blanket!)" },
        ...
        <div className="bg-secondary rounded-xl p-4 mb-10">
          <p className="font-body text-sm text-secondary-foreground">
            <Star size={12} className="inline text-accent mr-1" />
            <strong>Pro tip:</strong> February to April is the sweet spot — warm days, cool nights, fewer crowds, and the best stargazing conditions.
          </p>
        </div>

        {/* Packing */}
        <h2 className="font-heading text-2xl md:text-3xl font-bold text-foreground mb-4">What to Pack (Complete List)</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-10">
          {["Warm jacket or fleece (nights are cold)", "Sunscreen SPF 50+ & lip balm", "Sunglasses & wide-brimmed hat", "Comfortable closed shoes", "Scarf/shemagh for sand protection", "Small daypack for camel trek", "Camera + extra battery + power bank", "Refillable water bottle (1.5L+)", "Cash in small notes (no ATMs)", "Headlamp or small flashlight", "Motion sickness pills (winding roads)", "Toiletries (basic soap at camp only)"].map((item) => (
        ...
        {/* Photography */}
        <h2 className="font-heading text-2xl md:text-3xl font-bold text-foreground mb-4">Tips for Photographers</h2>
        <div className="space-y-3 mb-10">
          {[
        ...
        <div className="space-y-4 mb-10">
          {[
            { q: "How far is Marrakech from the Sahara?", a: "The Erg Chebbi dunes are about 550 km from Marrakech (one way). That's why the tour takes 3 days — it's too far for a day trip. The drive is scenic and broken up with multiple stops." },
            { q: "Is the desert cold at night?", a: "Yes! Desert temperatures can drop to 5°C in winter and 15°C even in spring/autumn. Bring warm layers. Luxury camps have heated tents." },
            { q: "Can I charge my phone?", a: "Standard camps usually don't have electricity. Luxury camps often do. Either way, bring a fully charged power bank." },
            { q: "Is it suitable for older travelers?", a: "Yes, the camel ride is gentle and suitable for most ages. The main consideration is the long driving days. If you have mobility issues, a private tour with more stops is recommended." },
            { q: "Can vegetarians/vegans be accommodated?", a: "Yes! Just let us know when booking. Moroccan cuisine naturally includes many vegetable dishes — couscous, vegetable tagines, salads, and fresh bread." },
          ].map((item, i) => (
        ...
        <div className="bg-card rounded-2xl p-8 shadow-warm-lg text-center">
          ...
          <p className="font-body text-muted-foreground mb-2">
            From 800 DH per person. No prepayment, free cancellation up to 24h before.
          </p>
          <p className="font-body text-sm text-muted-foreground mb-6">
            ✅ Hotel pickup · ✅ Camel trek · ✅ Desert camp · ✅ All transport included
          </p>
        ...
        <div className="mt-12 pt-10 border-t border-border">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <Link to="/guides/best-sahara-desert-tour-marrakech" className="bg-card rounded-xl p-4 shadow-warm hover:shadow-warm-lg transition-all group">
              <h4 className="font-heading text-sm font-bold text-foreground group-hover:text-primary transition-colors">Best Sahara Desert Tour from Marrakech</h4>
              <p className="font-body text-xs text-muted-foreground mt-1">Compare prices, routes & operators</p>
            </Link>
